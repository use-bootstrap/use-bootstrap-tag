      ...
      <nav class="navbar navbar-expand bg-body-tertiary sticky-top" data-bs-theme="dark">
        <div class="container justify-content-start">
          ...
          <div class="ms-auto navbar-nav align-items-center gap-3">
            <a class="fs-5 nav-link p-0" href={repository} target="_blank" aria-label="GitHub Project">
              <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div class="container pt-3">
          <nav class="overflow-x-auto" id="main-nav" style="margin-bottom: -1px">
            <ul class="nav nav-tabs flex-nowrap">
              ...
              <li class="nav-item">
                <a class={`nav-link ${path() === '/install' ? 'active' : ''}`} href="/install">Install</a>
              </li>
              <li class="nav-item">
                <a class={`nav-link ${path() === '/demo' ? 'active' : ''}`} href="/demo">Demo</a>
              </li>
              <li class="nav-item">
                <a class={`nav-link ${path() === '/api' ? 'active' : ''}`} href="/api">API</a>
              </li>
              <li class="nav-item">
                <a class={`nav-link ${path() === '/customize' ? 'active' : ''}`} href="/customize">Customize</a>
              </li>
            </ul>
          </nav>
        </div>
