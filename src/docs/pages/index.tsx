...
import { BsGithub, BsTags } from 'react-icons/bs/index.js'
...
export default function () {
  ...
  const css = [
    ...
    isDev ? 'use-bootstrap-tag.css' : 'use-bootstrap-tag.min.css',
  ...
  const js = [
    ...
    isDev ? 'use-bootstrap-tag.js' : 'use-bootstrap-tag.min.js',
